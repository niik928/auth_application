...
import com.example.auth_application.dtos.ErrorResponse;
...
public class GlobalExceptionHandle {
    ...
    public ResponseEntity<ApiError> handleAuthException(Exception e, HttpServletRequest request){
     ...
     var apiError = ApiError.of(HttpStatus.BAD_REQUEST.value(),"Bad Request" , e.getMessage(),request.getRequestURI(), true);
